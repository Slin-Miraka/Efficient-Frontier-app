...
RF = float(st.sidebar.text_input("Input Annualized risk-free rate","1.5%"))
...
st.write("")
st.write("")
st.write("**check out this for the codes in this app** [link](https://github.com/Slin-Miraka/Efficient-Frontier-app/)")
